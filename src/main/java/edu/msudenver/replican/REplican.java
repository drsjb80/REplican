...
public class REplican
{
    ...
    REplican ()
    {
        urls = new Hashtable<String, Boolean>();
    }
    ...
    private void loadCookies()
    {
        ...
        {
            logger.info ("Loading cookies from " + args.LoadCookies[i]);
    ...
    private void loadPlistCookies()
    {
	    ...
	    {
	        logger.info ("Loading cookies from " + args.PlistCookies[i]);
    ...
    ** @return                the interesting part if any, and null if none
    String rewrite (String s, String r)
    {
        logger.traceEntry (s);
        logger.traceEntry (r);
    ...
    */
    ...
    {
        logger.traceEntry (baseURL);
        logger.traceEntry (Arrays.toString(strings));

        for (int i = 0; i < strings.length; i++)
        {
            String next = Utils.replaceAll (strings[i], args.URLFixUp);
            ...
            // find the interesting parts of the URL
    ...
    private void printSpeed (long start, long stop, long read)
    {
