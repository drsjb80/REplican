...
public class FtpURLConnection extends URLConnection
{
    ...
    public InputStream getInputStream() { return (dis); }
    ...
    private void connectToDataSocket() throws UnknownHostException,
        IOException
    {
	...
	{
	    r = sendCommand (toSend[i], expect[i]);
	}
	...
	{
	    FtpURLConnection fuc = new FtpURLConnection (new URL (args[i]));
